...
public class XQueryTransformer extends AbstractXmlTransformer implements Disposable
{
    ...
    public XQueryTransformer()
    {
        ...
        registerSourceType(DataType.builder(DocumentSource.class).build());
        ...
        registerSourceType(DataType.builder(Element.class).build());
        registerSourceType(DataType.INPUT_STREAM);
        setReturnDataType(DataType.builder(List.class).build());
    }
