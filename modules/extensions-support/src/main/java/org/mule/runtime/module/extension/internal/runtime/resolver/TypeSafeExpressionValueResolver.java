...
public class TypeSafeExpressionValueResolver<T> implements ValueResolver<T>
{
    ...
    private T transform(T object, MuleEvent event) throws MuleException
    {
        ...
        org.mule.runtime.api.metadata.DataType sourceDataType = DataType.builder(object.getClass()).build();
        org.mule.runtime.api.metadata.DataType targetDataType = DataType.builder((Class<T>) expectedClass).build();
