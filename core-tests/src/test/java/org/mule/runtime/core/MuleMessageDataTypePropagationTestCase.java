...
public class MuleMessageDataTypePropagationTestCase extends AbstractMuleTestCase
{
    ...
    public void setsDataTypeFromPreviousMessageOnCreation() throws Exception
    {
        ...
        DataType dataType = DataType.builder(Long.class).forMimeType(APPLICATION_XML).withEncoding("UTF-16").build();
    ...
    public void setsNullPayloadWithDataType() throws Exception
    {
        ...
        DataType<Integer> newDataType = DataType.builder(Integer.class).forMimeType(APPLICATION_XML).withEncoding(CUSTOM_ENCODING).build();
    ...
    public void updatesTypeOnTransformation() throws Exception
    {
        ...
        DataType outputDataType = DataType.builder(Integer.class).forMimeType(ANY).build();
    ...
    public void updatesEncodingOnTransformation() throws Exception
    {
        ...
        Transformer transformer = mock(Transformer.class);
        when(transformer.isSourceDataTypeSupported(org.mockito.Matchers.<DataType<?>>any())).thenReturn(true);
        DataType outputDataType = DataType.builder(Integer.class).withEncoding(CUSTOM_ENCODING).build();
        when(transformer.getReturnDataType()).thenReturn(outputDataType);
    ...
    public void maintainsDataTypeSubClassTypeTransformation() throws Exception
    {
        ...
        DataType originalDataType = DataType.builder(RuntimeException.class).forMimeType(ANY).build();
        muleMessage.setDataType(originalDataType);

        Transformer transformer = mock(Transformer.class);
        DataType outputDataType = DataType.builder(Object.class).forMimeType(ANY).build();
        when(transformer.getReturnDataType()).thenReturn(outputDataType);
    ...
    public void updatesMimeTypeOnTransformation() throws Exception
    {
        ...
        Transformer transformer = mock(Transformer.class);
        when(transformer.isSourceDataTypeSupported(org.mockito.Matchers.<DataType<?>>any())).thenReturn(true);
        DataType outputDataType = DataType.builder(Integer.class).forMimeType(APPLICATION_XML).build();
        when(transformer.getReturnDataType()).thenReturn(outputDataType);
    ...
    {
        DataType<Integer> dataType = DataType.builder(Integer.class).build();
    ...
    {
        DefaultMuleMessage muleMessage = new DefaultMuleMessage(TEST, muleContext);
        DataType<String> dataType = DataType.builder(String.class).forMimeType(APPLICATION_XML).withEncoding(CUSTOM_ENCODING).build();
