...
public class DataTypeBuilderTestCase extends AbstractMuleTestCase
{
    ...
    {
        final DataType<String> dataType = DataType.builder(String.class).build();
    ...
    {
        final DataType<Set> dataType = DataType.builder(Set.class).build();
    ...
    {
        final DataType<Set> dataType = DataType.builder().collectionType(List.class, String.class).build();
        assertThat(dataType, instanceOf(CollectionDataType.class));
    ...
    public void templateTypedCollection()
    {
        final DataType<Set> template = DataType.builder()
                                               .collectionType(List.class, String.class)
    ...
    public void buildCollectionFails()
    {
        ...
        final DataTypeBuilder builder = DataType.builder().collectionType(String.class, String.class);
    }
    ...
    public void proxy()
    {
        ...
        final DataType dataType = DataType.builder(muleMessageProxy).build();
    ...
    {
        final DataTypeBuilder<String> builder = DataType.builder(String.class);
        builder.build();
    ...
    {
        final DataTypeBuilder<String> builder1 = DataType.builder(String.class);
        final DataTypeBuilder<String> builder2 = DataType.builder(String.class);
