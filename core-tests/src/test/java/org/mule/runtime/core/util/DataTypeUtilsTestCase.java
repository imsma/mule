...
public class DataTypeUtilsTestCase extends AbstractMuleTestCase
{
    ...
    {
        final DataType dataType = DataType.builder(Object.class).forMimeType(APPLICATION_JSON).withEncoding(UTF_8.name()).build();
    ...
    {
        DataType<Object> dataType = DataType.builder(Object.class).forMimeType(MimeTypes.APPLICATION_JSON).build();
