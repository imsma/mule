...
public class TransformerResolutionTestCase extends AbstractMuleContextTestCase
{
    ...
    public static final DataType<Fruit> FRUIT_DATA_TYPE = DataType.builder(Fruit.class).build();
    public static final DataType<Orange> ORANGE_DATA_TYPE = DataType.builder(Orange.class).build();
    public static final DataType<Apple> APPLE_DATA_TYPE = DataType.builder(Apple.class).build();
