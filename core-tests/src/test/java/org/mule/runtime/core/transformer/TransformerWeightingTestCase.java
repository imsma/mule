...
public class TransformerWeightingTestCase extends AbstractMuleTestCase
{
    ...
    {
        Transformer trans = new MockConverterBuilder().from(DataType.builder(IOException.class).build()).to(DataType.BYTE_ARRAY).build();
    ...
    {
        Transformer trans = new MockConverterBuilder().from(DataType.builder(Serializable.class).build()).to(DataType.BYTE_ARRAY).build();
    ...
    {
        Transformer trans1 = new MockConverterBuilder().from(DataType.builder(Serializable.class).build()).to(DataType.BYTE_ARRAY).build();
        Transformer trans2 = new MockConverterBuilder().from(DataType.builder(Exception.class).build()).to(DataType.BYTE_ARRAY).build();
    ...
    {
        Transformer trans1 = new MockConverterBuilder().from(DataType.builder(Serializable.class).build()).to(DataType.BYTE_ARRAY).build();
        Transformer trans2 = new MockConverterBuilder().from(DataType.builder(IOException.class).build()).to(DataType.BYTE_ARRAY).build();
    ...
    {
        Transformer trans1 = new MockConverterBuilder().from(DataType.builder(Serializable.class).build()).to(DataType.BYTE_ARRAY).build();
        Transformer trans2 = new MockConverterBuilder().from(DataType.builder(FruitBowl.class).build()).to(DataType.BYTE_ARRAY).build();
