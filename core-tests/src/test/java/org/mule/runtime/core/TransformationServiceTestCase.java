...
public class TransformationServiceTestCase extends AbstractMuleTestCase
{
    ...
    private static final DataType<B> dataTypeB = DataType.builder(B.class).build();
    private static final DataType<C> dataTypeC = DataType.builder(C.class).build();
    private static final DataType<D> dataTypeD = DataType.builder(D.class).build();
